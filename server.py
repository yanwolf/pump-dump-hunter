...
<h2>訊號（最新在上） <button onclick="sigclear()" style="font-size:12px;padding:3px 8px">清除訊號紀錄</button></h2>${T(sig,['time','symbol','engine','side','entry','stop','stop_pct','leverage','notional','executed','reason'],r=>r.side=='LONG'?'long':'short')}
