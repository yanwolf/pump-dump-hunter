...
TESTS = ["tests.test_r12", "tests.test_r15", "tests.test_r18", "tests.test_r21", "tests.test_r24", "tests.test_r27", "tests.test_r30", "tests.test_r33", "tests.test_r36", "tests.test_r39", "tests.test_r43", "tests.test_r47", "tests.test_r50", "tests.test_maxqty"]
